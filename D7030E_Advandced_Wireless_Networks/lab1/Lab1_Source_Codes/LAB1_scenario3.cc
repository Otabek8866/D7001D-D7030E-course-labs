...
NS_LOG_COMPONENT_DEFINE ("LAB1_3");
...
/////////////////////////////Nodes/////////////////////////////  
 ...
 /////////////////////////////Wi-Fi part///////////////////////////// 
  ...
  Ptr<FriisPropagationLossModel> lossModel = CreateObject<FriisPropagationLossModel> (); //create a pointer for propagation loss model
...
/////////////////////////////Devices///////////////////////////// 
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAlloc->Add (Vector (292.2, 0.0, 1.0)); //292.2 for Friis propagation model
...
/////////////////////////////PCAP tracing/////////////////////////////   
  phy.EnablePcap ("LAB1_3", staDevices .Get (nWifi-1), true);
  phy.EnablePcap ("LAB1_3", staDevices .Get (0), true); 
