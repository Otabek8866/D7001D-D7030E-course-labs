...
public class SimpleAgent extends Agent {
            ...
            protected void onTick() {
                try {
                    ...
                    while ((output = bf.readLine()) != null) {
                        ...
                        //System.out.println(report_to_architect + " Trying to print:" + architect_ip);
                    }
                    addBehaviour(sm);
    ...
    public class SendMessage extends OneShotBehaviour {
        ...
        public void action() {
            ACLMessage msg;
            //String receiverName = "Architect@" + architect_ip + ":1099/JADE";
            ...
            //aid.addAddresses("http://" + architect_ip + ":1099/acc");
